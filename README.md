...
```
cd existing_repo
git remote add origin https://gitlab.com/pradipkakade7777-group/solar-system.git
git branch -M main
...
* [Set up project integrations](https://gitlab.com/pradipkakade7777-group/solar-system/-/settings/integrations)
